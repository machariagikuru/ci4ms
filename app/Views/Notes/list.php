...
<div class="container py-4">
    <h2 class="mb-4 fw-bold" style="color: #074C87;">Notes</h2>
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text" style="color: #555; line-height: 1.5; font-size: 0.95rem;">
                                <small class="text-muted" style="color: #6c757d !important;">
                                    ...
                                    <?php if (!empty($note->category_name)): ?> • <?= esc($note->category_name) ?><?php endif; ?>
                                    <?php if (!empty($note->tag_name)): ?> • <?= esc($note->tag_name) ?><?php endif; ?>
                                </small><br>
                                <?= esc($note->description ?? '') ?>
                                <?php if (!empty($note->content)): ?>
                                    <div class="mt-2"><?= esc(substr(strip_tags($note->content), 0, 100)) ?>...</div>
                                <?php endif; ?>
                            </p>
                        </div>
